...
struct ColorPalette {
    ...
    static let accentLiteTheme = Color(red: 65 / 255.0, green: 69 / 255.0, blue: 100 / 255.0)
    static let gray0 = Color(red: 24 / 255.0, green: 24 / 255.0, blue: 24 / 255.0)
    static let gray0_5 = Color(red: 34 / 255.0, green: 34 / 255.0, blue: 34 / 255.0)
    ...
    static let gray4_5 = Color(red: 171 / 255.0, green: 169 / 255.0, blue: 179 / 255.0)
    static let gray5 = Color(red: 221 / 255.0, green: 219 / 255.0, blue: 229 / 255.0)
    static let gray6 = Color(red: 239 / 255.0, green: 239 / 255.0, blue: 239 / 255.0)
    static let red0 = Color(red: 250 / 255.0, green: 82 / 255.0, blue: 82 / 255.0)
}

protocol Colors {
    var accent: Color { get }
    var accentLite: Color { get }
...
struct ColorsLight: Colors {
    let accent = ColorPalette.accentTheme
    let accentLite = ColorPalette.accentLiteTheme
    let backgroundPrimary = ColorPalette.gray5
